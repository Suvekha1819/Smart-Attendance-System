...
window = tk.Tk()
window.title("SMART ATTENDENCE MANAGEMENT SYSTEM")
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def err_screen1():
                ...
                Button(errsc2, text='OK', command=del_errsc2, fg="blue", bg="lawn green", width=9, height=1,
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    ...
                    Notifica.configure(
                        text=e, bg="#6E23A8", fg="blue", width=60, font=('times', 15, 'bold'))
